    ...
    public static class EntitiesMap
    {
        ...
        static EntitiesMap()
        {
            Mapper = new MapperConfiguration(config =>
            {
                ...
                config.CreateMap<Services.InMemory.InMemoryUser, Entities.User>(MemberList.Source)
                    .ForMember(x => x.Claims, opts => opts.MapFrom(src => src.Claims.Select(x => new Entities.UserClaim { Type = x.Type, Value = x.Value })));
        ...
        public static Entities.User ToEntity(this Services.InMemory.InMemoryUser s)
        {
            if (s == null) return null;
            ...
            return Mapper.Map<Services.InMemory.InMemoryUser, Entities.User>(s);
        }
    }
}
