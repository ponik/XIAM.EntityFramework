...
using IdentityServer3.EntityFramework.Services;
...
namespace IdentityServer3.Core.Configuration
{
    public static class IdentityServerServiceFactoryExtensions
    {
        ...
        public static void RegisterConfigurationServices(this IdentityServerServiceFactory factory, EntityFrameworkServiceOptions options)
        {
            ...
            factory.RegisterUserStore(options);
        }
        ...
        public static void RegisterUserStore(this IdentityServerServiceFactory factory, EntityFrameworkServiceOptions options)
        {
            if (factory == null) throw new ArgumentNullException("factory");
            if (options == null) throw new ArgumentNullException("options");
            ...
            factory.Register(new Registration<IUserConfigurationDbContext>(resolver => new UserConfigurationDbContext(options.ConnectionString, options.Schema)));
